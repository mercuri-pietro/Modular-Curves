...
The file "Computation_of_equations.txt" contains the code to compute the equations of the canonical model of the quotient modular curve X(6,7)/<w_6,w_7>.
...
The file "Equations_other_maximal_curves.txt" contains the code to compute the equations of the canonical model of the quotient modular curves X_0(81), X_0(251)/<w_251>, X_0(177)/<w_59>, X_0(299)/<w_299>. 
